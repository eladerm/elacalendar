...
export function NodeConfigPanel({ 
              ...
              return (
                  <div className="space-y-4">
                      <div>
                          ...
                          <textarea 
                             className={cn("w-full text-sm p-2.5 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none resize-none", isFullscreen ? "min-h-[200px]" : "min-h-[80px]")}
              ...
              return (
                  <div className="space-y-4">
                      <div>
                          ...
                          <textarea 
                             className={cn("w-full text-sm p-2.5 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none resize-none", isFullscreen ? "min-h-[300px]" : "min-h-[120px]")}
  ...
  return (
      <div
        className="fixed right-0 w-[360px] bg-white border-l border-slate-200 shadow-2xl z-[9000] flex flex-col"
      ...
      >
          ...
          <div className="h-14 border-b border-slate-100 flex items-center justify-between px-4 shrink-0 bg-slate-50/50">
             <div className="flex items-center gap-2">
                 <div className="w-7 h-7 bg-white rounded shadow-sm border border-slate-200 flex items-center justify-center">
                    {getIcon()}
                 </div>
          ...
          {/* Panel Footer */}
          <div className="p-4 border-t border-slate-100 bg-slate-50/50 shrink-0 flex gap-2">
             <button
               onClick={(e) => { e.stopPropagation(); setIsFullscreen(true); }}
               className="flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-blue-600 border border-slate-200 hover:border-blue-300 px-3 py-2 rounded-lg transition-colors bg-white"
             >
