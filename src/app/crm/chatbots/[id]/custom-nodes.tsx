...
export const TriggerNode = memo(({ data, selected }: any) => {
  return (
    <div className={cn(
      ...
      selected ? "border-emerald-500 shadow-md shadow-emerald-500/10 ring-1 ring-emerald-500" : "border-slate-200 shadow-sm hover:shadow-md hover:border-slate-300"
    )}>
...
export const MessageNode = memo(({ data, selected }: any) => {
  return (
    <div className={cn(
      ...
      selected ? "border-blue-500 shadow-md shadow-blue-500/10 ring-1 ring-blue-500" : "border-slate-200 shadow-sm hover:shadow-md hover:border-slate-300"
    )}>
      <Handle type="target" position={Position.Left} className="w-3 h-3 bg-slate-100 border-[2px] border-slate-300" />
      ...
      <Handle type="source" position={Position.Right} className="w-3 h-3 bg-white border-[2px] border-blue-500" />
    </div>
  );
});
...
export const WaitNode = memo(({ data, selected }: any) => {
  return (
    <div className={cn(
      ...
      <Handle type="source" position={Position.Right} className="w-3 h-3 bg-white border-[2px] border-slate-400" />
    </div>
  );
});
    ...
    <div className={cn(
      ...
      <div className="p-3 flex flex-col gap-2 relative">
         <div className="border border-slate-200 rounded-lg p-2.5 flex flex-col gap-2 bg-white relative">
             ...
             <Handle type="source" id="yes" position={Position.Right} style={{ top: '50%', right: '-12px' }} className="w-3 h-3 bg-white border-[2px] border-emerald-500" />
         </div>
         ...
         <div className="border border-slate-200 rounded-lg p-2.5 flex flex-col gap-2 bg-white relative mt-1">
            <div className="text-[12px] text-slate-600 font-medium flex items-center">
             ...
             <Handle type="source" id="no" position={Position.Right} style={{ top: '50%', right: '-12px' }} className="w-3 h-3 bg-white border-[2px] border-rose-400" />
         </div>
      </div>
    </div>
  );
...
export const TagNode = memo(({ data, selected }: any) => {
  ...
  return (
    <div className={cn(
      ...
      <Handle type="source" position={Position.Right} className="w-3 h-3 bg-white border-[2px] border-purple-500" />
    </div>
  );
});
...
export const CaptureNode = memo(({ data, selected }: any) => {
  return (
    <div className={cn(
      ...
      <Handle type="source" position={Position.Right} className="w-3 h-3 bg-white border-[2px] border-pink-500" />
    </div>
  );
});
...
export const MediaNode = memo(({ data, selected }: any) => {
  return (
    <div className={cn(
      ...
      <Handle type="source" position={Position.Right} className="w-3 h-3 bg-white border-[2px] border-cyan-500" />
    </div>
  );
});
    ...
    <div className={cn(
      ...
      <div className="p-3 flex flex-col gap-2 relative">
         <div className="border border-slate-200 rounded-lg p-2.5 flex flex-col gap-2 bg-white relative">
             ...
             <Handle type="source" id="in_hours" position={Position.Right} style={{ top: '50%', right: '-12px' }} className="w-3 h-3 bg-white border-[2px] border-emerald-500" />
         </div>
         ...
         <div className="border border-slate-200 rounded-lg p-2.5 flex flex-col gap-2 bg-white relative mt-1">
            <div className="text-[12px] text-slate-600 font-medium flex items-center">
             ...
             <Handle type="source" id="out_hours" position={Position.Right} style={{ top: '50%', right: '-12px' }} className="w-3 h-3 bg-white border-[2px] border-rose-400" />
         </div>
      </div>
    </div>
  );
...
export const ApiCallNode = memo(({ data, selected }: any) => {
  return (
    <div className={cn(
      ...
      <Handle type="source" position={Position.Right} className="w-3 h-3 bg-white border-[2px] border-fuchsia-500" />
    </div>
  );
});
